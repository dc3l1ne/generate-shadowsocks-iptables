...
class Main:
	...
	def to_file(self):
		...
		f.write(' -t nat -A SHADOWSOCKS -d 0.0.0.0/8 -j RETURN\n')
		f.write(' -t nat -A SHADOWSOCKS -d 10.0.0.0/8 -j RETURN\n')
		f.write(' -t nat -A SHADOWSOCKS -d 127.0.0.0/8 -j RETURN\n')
		f.write(' -t nat -A SHADOWSOCKS -d 169.254.0.0/16 -j RETURN\n')
		f.write(' -t nat -A SHADOWSOCKS -d 172.16.0.0/12 -j RETURN\n')
		f.write(' -t nat -A SHADOWSOCKS -d 192.168.0.0/16 -j RETURN\n')
		f.write(' -t nat -A SHADOWSOCKS -d 224.0.0.0/4 -j RETURN\n')
		f.write(' -t nat -A SHADOWSOCKS -d 240.0.0.0/4 -j RETURN\n')
